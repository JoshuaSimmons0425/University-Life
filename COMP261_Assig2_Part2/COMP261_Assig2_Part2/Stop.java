...
public class Stop implements Comparable<Stop> {    
    ...
    private Collection<Edge> edgesOut = new HashSet<Edge>();
    
    // data structure for holding the (directed) edges going into the stop
    
    private Collection<Edge> edgesIn = new HashSet<Edge>();
    ...
    public Collection<Edge> getEdgesOut() {
        return Collections.unmodifiableCollection(edgesOut);
    }
    
    public Collection<Edge> getEdgesIn(){
        return Collections.unmodifiableCollection(edgesIn);
    }
    ...
    public void deleteEdgesOfType(String type) {
        ...
        edgesOut.removeIf((Edge e)->type.equals(e.transpType()));
        edgesIn.removeIf((Edge e)->type.equals(e.transpType()));
    }
}
