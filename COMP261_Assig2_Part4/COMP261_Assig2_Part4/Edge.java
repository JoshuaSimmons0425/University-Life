...
public class Edge {
    ...
    private final int travelTimeSeconds; // added field to store the travel time of the edge in seconds
    ...
    public Edge(Stop fromStop, Stop toStop, String transpType, Line line, int travelTimeSeconds, double distance){
    ...
    public int getTravelTime() {return line == null ? (int)(distance / Transport.WALKING_SPEED_MPS) : travelTimeSeconds;}
